...
def parse_args():
    ...
    # parser.add_argument('--device', default='cuda:1', help='device assignment ("cpu" or "cuda")')
...
def main():
    ...
    if args.model_dir != '':
        ...
        name = 'rnn_size=%d-predictor-posterior-rnn_layers=%d-%d-n_past=%d-n_future=%d-lr=%.4f-g_dim=%d-z_dim=%d-last_frame_skip=%s-beta=%.7f-monotonic(fixed_prior)'\
